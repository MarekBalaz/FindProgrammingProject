...
const Signup = () => {
  return (
    ...
    <form class='flex flex-col justify-around'>
      ...
      <input type="email" placeholder="Email address" class='p-2 border-solid border-2 border-gray-300 rounded-md mb-4'/>
      <input type='password' placeholder='Create password' class='p-2 border-solid border-2 border-gray-300 rounded-md mb-4'/>
      <input type='password' placeholder='Confirm password' class='p-2 border-solid border-2 border-gray-300 rounded-md mb-4'/>
      <hr />
      <div>
        <input type='submit' value='Login' class='px-4 py-2 my-4 bg-blue-600 rounded-md text-white hover:scale-110 hover:bg-blue-700 transition-all duration-300 cursor-pointer hover:shadow-lg'/>
      </div>
